 ...
 *
 */
public class MStick extends MAbstractControl {
	 ...
	 * @param p3
	 */
	public MStick(PApplet theApplet, float p0, float p1, float p2, float p3) {
		...
		createEventHandler(M4P.sketchApplet, "handleStickEvents",
				new Class<?>[]{ MStick.class, MEvent.class }, 
