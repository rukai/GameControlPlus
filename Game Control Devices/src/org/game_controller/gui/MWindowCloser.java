 ...
 *
 */
public class MWindowCloser {

	
	private ArrayList<MWindow> toDisposeOf;
		
		MWindowCloser() {
			toDisposeOf = new ArrayList<MWindow>();
		}
		
		public void addWindow(MWindow gwindow){
