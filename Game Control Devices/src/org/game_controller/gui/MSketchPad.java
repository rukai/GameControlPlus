 ...
 *
 */
public class MSketchPad extends MAbstractControl {
	...
	public MSketchPad(PApplet theApplet, float p0, float p1, float p2, float p3) {
		super(theApplet, p0, p1, p2, p3);
		cursorOver = M4P.mouseOff; // does not change
