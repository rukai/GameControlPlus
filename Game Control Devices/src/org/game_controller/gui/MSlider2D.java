 ...
 *
 */
public class MSlider2D extends MValueControl2D {
	 ...
	 * @param p3
	 */
	public MSlider2D(PApplet theApplet, float p0, float p1, float p2, float p3) {
		...
		createEventHandler(M4P.sketchApplet, "handleSlider2DEvents",
				new Class<?>[]{ MSlider2D.class, MEvent.class },
