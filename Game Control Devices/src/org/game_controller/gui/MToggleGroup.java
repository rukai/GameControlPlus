 ...
 *
 */
public class MToggleGroup {

	private MToggleControl selected = null;
	private MToggleControl deselected = null;
	 ...
	 * @param tc
	 */
	public void addControl(MToggleControl tc){
	 ...
	 * @param controls
	 */
	public void addControls(MToggleControl... controls ){
		for(MToggleControl tc : controls)
			tc.setToggleGroup(this);			
	}
