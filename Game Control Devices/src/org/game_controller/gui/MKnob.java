...
import org.game_controller.gui.MHotSpot.HSarc;
import org.game_controller.gui.MHotSpot.HScircle;
 ...
 *
 */
public class MKnob extends MValueControl {
	 ...
	 */
	public MKnob(PApplet theApplet, float p0, float p1, float p2, float p3, float gripAmount) {
		...
		createEventHandler(M4P.sketchApplet, "handleKnobEvents",
