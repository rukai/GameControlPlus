 ...
 *
 */
public class MPanel extends MTextBase {
	 ...
	 */
	public MPanel(PApplet theApplet, float p0, float p1, float p2, float p3) {
	 ...
	 */
	public MPanel(PApplet theApplet, float p0, float p1, float p2, float p3, String text) {
		...
		createEventHandler(M4P.sketchApplet, "handlePanelEvents", 
				new Class<?>[]{ MPanel.class, MEvent.class },
	...
	public void mouseEvent(MouseEvent event){
		...
		case MouseEvent.CLICK:
			if(focusIsWith == this && collapsible){
				...
				constrainPanelPosition();
				if(tabOnly)
					fireEvent(this, MEvent.COLLAPSED);
				else
					fireEvent(this, MEvent.EXPANDED);
				beingDragged = false;
