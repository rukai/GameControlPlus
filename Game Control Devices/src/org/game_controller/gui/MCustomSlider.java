 ...
 *
 */
public class MCustomSlider extends MLinearTrackControl {
	 ...
	 * @param p3
	 */
	public MCustomSlider(PApplet theApplet, float p0, float p1, float p2, float p3) {
	 ...
	 */
	public MCustomSlider(PApplet theApplet, float p0, float p1, float p2, float p3, String skin) {
		...
		buffer.g2.setFont(M4P.numericLabelFont);
		...
		createEventHandler(M4P.sketchApplet, "handleSliderEvents", 
				new Class<?>[]{ MValueControl.class, MEvent.class },
