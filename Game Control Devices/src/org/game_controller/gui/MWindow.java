...
public class MWindow extends Frame implements MConstants, MConstantsInternal {
	 ...
	 */
	public MWindow(PApplet theApplet, String name, int x, int y, int w, int h, boolean noFrame, String mode) {
		super(name);
		winName = name;
	 ...
	 */
	public MWindow(PApplet theApplet, String name, int x, int y, PImage image, boolean noFrame, String mode) {
		super(name);
	...
	public void addOnCloseHandler(Object obj, String methodName){
		try{
			...
			closetHandlerMethod = obj.getClass().getMethod(methodName, new Class<?>[] {MWindow.class } );
		} catch (Exception e) {
	...
	public void addDrawHandler(Object obj, String methodName){
		try{
			drawHandlerMethod = obj.getClass().getMethod(methodName, new Class<?>[] {MWinApplet.class, MWinData.class } );
			drawHandlerObject = obj;
			drawHandlerMethodName = methodName;
		} catch (Exception e) {
			MMessenger.message(NONEXISTANT, new Object[] {this, methodName, new Class<?>[] { MWinApplet.class, MWinData.class } } );
		}
	}
	...
	public void addPreHandler(Object obj, String methodName){
		try{
			preHandlerMethod = obj.getClass().getMethod(methodName, new Class<?>[] {MWinApplet.class, MWinData.class } );
	...
	public void addMouseHandler(Object obj, String methodName){
		try{
			mouseHandlerMethod = obj.getClass().getMethod(methodName, 
					new Class<?>[] {MWinApplet.class, MWinData.class, MouseEvent.class } );
			mouseHandlerObject = obj;
			mouseHandlerMethodName = methodName;
		} catch (Exception e) {
			MMessenger.message(NONEXISTANT, new Object[] {this, methodName, new Class<?>[] { MWinApplet.class, MWinData.class, MouseEvent.class } } );
		}
	}
	...
	public void addKeyHandler(Object obj, String methodName){
		try{
			keyHandlerMethod = obj.getClass().getMethod(methodName, 
					new Class<?>[] {MWinApplet.class, MWinData.class, KeyEvent.class } );
			keyHandlerObject = obj;
			keyHandlerMethodName = methodName;
		} catch (Exception e) {
			MMessenger.message(NONEXISTANT, new Object[] {this, methodName, new Class<?>[] { MWinApplet.class, MWinData.class, KeyEvent.class } } );
		}
	}
	...
	public void addPostHandler(Object obj, String methodName){
		try{
			postHandlerMethod = obj.getClass().getMethod(methodName, 
					new Class<?>[] {MWinApplet.class, MWinData.class } );
	...
	public class GWindowAdapter extends WindowAdapter {
		...
		public GWindowAdapter(MWindow window){
			this.window = window;
		}
		...
		public void windowClosing(WindowEvent evt) {
			...
			case CLOSE_WINDOW:
				...
				M4P.markWindowForClosure(window);
				break;
			case EXIT_APP:
				System.exit(0);
				break;
