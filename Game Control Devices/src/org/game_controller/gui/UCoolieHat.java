...
public class UCoolieHat extends UBaseInput {
	...
	public UCoolieHat(UControlConfigWindow ccw, ControlCoolieHat pbutton, float x, float y) {
		super(ccw, x, y, 1, 5);
		uiType = UI_COOLIEHAT;
		inputTypeName = "HAT";
		button = pbutton;
		float fieldHeight = ccw.input_UI_height * ccw.scale;
		txfMultiplier = new MTextField(app, x + 130, y + 2 + 2 * ccw.input_UI_height, 80, fieldHeight, M4P.SCROLLBARS_NONE);
