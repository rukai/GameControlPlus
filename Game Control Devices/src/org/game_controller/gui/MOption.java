 ...
 *
 */
public class MOption extends MToggleControl{
	 ...
	 * @param p3
	 */
	public MOption(PApplet theApplet, float p0, float p1, float p2, float p3) {
	 ...
	 */
	public MOption(PApplet theApplet, float p0, float p1, float p2, float p3, String text) {
		super(theApplet, p0, p1, p2, p3);
		opaque = false;
		setText(text);
		setIcon("pinhead.png", 2, MAlign.LEFT, null);
