 ...
 *
 */
abstract class MHotSpot implements MConstants, Comparable<MHotSpot> {
	...
	protected MHotSpot(int id){
		this.id = Math.abs(id);
	}

	public void adjust(Object ... arguments){}

	public int compareTo(MHotSpot spoto) {
	 ...
	 * @author Peter Lager
	 */
	static class HSrect extends MHotSpot {
		public float w, h;
	 ...
	 *
	 */
	static class HSarc extends MHotSpot {
	 ...
	 * @author Peter Lager
	 */
	static class HScircle extends MHotSpot {
		public float r, r2;
	 ...
	 *
	 */
	static class HSmask extends MHotSpot {
	 ...
	 *
	 */
	static class HSalpha extends MHotSpot {
