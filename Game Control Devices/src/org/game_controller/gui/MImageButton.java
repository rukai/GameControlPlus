...
import org.game_controller.gui.MHotSpot.HSmask;
 ...
 *
 */
public class MImageButton extends MAbstractControl {
	 ...
	 */
	public MImageButton(PApplet theApplet, float p0, float p1, String[] fnames) {
	 ...
	 */
	public MImageButton(PApplet theApplet, float p0, float p1, String[] fnames, String fnameMask) {
	 ...
	 * @param fnames an array of up to 3 image filenames to represent the off/over/down state of the button.
	 */
	public MImageButton(PApplet theApplet, float p0, float p1, float p2, float p3, String[] fnames) {
	 ...
	 * @param fnameMask the alpha mask filename or null if no mask
	 */
	public MImageButton(PApplet theApplet, float p0, float p1, float p2, float p3, String[] fnames, String fnameMask) {
		super(theApplet, p0, p1, p2, p3);
		if(errImage == null)
			errImage = MImageManager.loadImage(winApp, new String[] { "err0.png", "err1.png", "err2.png" });
		...
		bimage = MImageManager.loadImage(winApp, fnames);
		...
		createEventHandler(M4P.sketchApplet, "handleButtonEvents",
				new Class<?>[]{ MImageButton.class, MEvent.class }, 
